...
export abstract class BaseLotteryAdapter {
  ...
  public verifySourceOrigin(sourceUrl: string): boolean {
    ...
    const authorizedDomainPatterns = [
      ...
      /keralalotteries\.net/i,
      /keralalotteryresult\.net/i,
      /nagalandlotteries\.com/i,
      /nagalandstatelotteries\.com/i,
      /nagalandstatelottery\.in/i,
      /nagalandstatelotteries\.in/i,
      /sikkimlotteries\.com/i,
      /sikkimstatelotteries\.com/i,
      /punjabstatelotteries\.gov\.in/i,
      /punjabstatelotteryresult\.com/i,
      /goastatelotteries\.gov\.in/i,
      /rajshreeweeklylottery\.com/i,
      /mizoramlottery\.in/i,
      /ifsl\.mizoram\.gov\.in/i,
      /lottery\.maharashtra\.gov\.in/i,
      /finance\.maharashtra\.gov\.in/i,
      /wb\.gov\.in/i,
      /wbfin\.nic\.in/i,
      /westbengallottery\.gov\.in/i,
      /westbengallottery\.in/i,
      /lotteryindia\.gov\.in/i,
      /arunachalstatelotteries\.in/i,
      /arunachallottery\.com/i,
      /meghalayastatelottery\.com/i,
      /meghalaya\.gov\.in/i,
