...
export const STATE_SEO_MAP: Record<string, StateSeoConfig> = {
  KL: {
    ...
    name: 'Kerala',
    seoTitle: 'Kerala Lottery Result Today | Win-Win, Fifty-Fifty, Karunya & Bumper Results',
    metaDescription: 'Check Kerala lottery result today live at 3:00 PM. Winning numbers for Fifty-Fifty, Win-Win, Sthree Sakthi, Nirmal, Karunya & Bumper draws with gazette references.',
    h1: 'Kerala Lottery Result Today (3:00 PM Draw)',
    h2: 'Kerala State Lotteries Draw Results & Gazette Archive',
    ...
    gazetteNotice: 'Lottery conducted by Taxes Department, Government of Kerala. 1st Prize ₹70 Lakhs to ₹1 Crore, Bumper up to ₹25 Crores.'
  },
  NL: {
    code: 'NL',
    slug: 'nagaland-lottery-result',
    name: 'Nagaland',
    seoTitle: 'Nagaland Lottery Result Today | Dear Lottery Sambad 1 PM, 6 PM, 8 PM Draw Results',
    metaDescription: 'Nagaland state lottery result today live updates at 1:00 PM, 6:00 PM, and 8:00 PM. Dear Lottery Sambad 1st prize ₹1 Crore winning numbers and gazette references.',
    h1: 'Nagaland Lottery Result Today (Dear Lottery Sambad)',
    h2: 'Dear 1 PM, 6 PM & 8 PM Draw Winning Numbers & Reference',
    ...
    gazetteNotice: 'Conducted under Directorate of Nagaland State Lotteries. Guaranteed 1st Prize of ₹1,00,00,000 (₹1 Crore) with 10 series.'
  },
  SK: {
    code: 'SK',
    ...
    h2: 'Sikkim State Lotteries Winning Numbers & Gazette Reference',
  ...
  PB: {
    ...
    metaDescription: 'Punjab state lottery result today. Winning numbers for Punjab State Dear 100 Monthly, Dear 200, Lohri Bumper, and Diwali Bumper draws.',
    h1: 'Punjab Lottery Result Today',
    h2: 'Punjab State Lotteries Draw Archives & Bumper Results',
  ...
  GA: {
    ...
    metaDescription: 'Goa state lottery result today. Winning numbers for Rajshree 50 Som Weekly, Rajshree Everest, and Rajshree 200 Monthly paper lottery draws.',
    h1: 'Goa Lottery Result Today (Rajshree Draws)',
    h2: 'Directorate of Small Savings and Lotteries Goa Gazette Reference',
  ...
  MZ: {
    ...
    metaDescription: 'Mizoram state lottery result today. Draw winning numbers for Golden King Weekly, Silver Weekly, and Mizoram Diamond Bumper draws.',
    h1: 'Mizoram Lottery Result Today',
    h2: 'Directorate of IF&SL Mizoram Draw Gazette Reference',
  ...
  MH: {
    ...
    metaDescription: 'Maharashtra state lottery result today. Winning numbers for Maharashtra Gajlaxmi Som, Gajlaxmi Budh, Surabhi, and Mahalaxmi weekly draws.',
    h1: 'Maharashtra Lottery Result Today',
    h2: 'Directorate of Maharashtra State Lotteries Draw Archives',
  ...
  WB: {
    ...
    metaDescription: 'West Bengal lottery result today. Winning numbers for Bangalakshmi Weekly, Bangabhumi, Bangashree Super, and Dear Bengal Bumper draws.',
    h1: 'West Bengal Lottery Result Today',
    h2: 'West Bengal Directorate of State Lotteries Draw Results & Gazette Reference',
    ...
    gazetteNotice: 'Lottery results verified against publicly available West Bengal state gazette notifications.'
  },
  AR: {
    code: 'AR',
    ...
    metaDescription: 'Arunachal Pradesh state lottery result today. Winning numbers for Singam Peak Weekly (11:55 AM), LabhLaxmi Som (5:00 PM), and Arunachal Super draws.',
    h1: 'Arunachal Pradesh Lottery Result Today',
    h2: 'Directorate of Arunachal Pradesh State Lotteries Draw Archives',
  ...
  ML: {
    ...
    metaDescription: 'Meghalaya state lottery result today. Winning numbers for Singam Meghalaya Day (12:30 PM), Kuwait Weekly (3:30 PM), and licensed Khanapara Teer results.',
